...
namespace Humica.Controllers.HRM.EForm
{
    public class EFEPortalAssignTeamController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "EFE0000001";
        private const string URL_SCREEN = "/HRM/EForm/EFEPortalAssignTeam/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName;
        private string KeyName = "ApprID";
        protected IClsEFEmpPortal BSM;
        public EFEPortalAssignTeamController()
            : base()
        {
