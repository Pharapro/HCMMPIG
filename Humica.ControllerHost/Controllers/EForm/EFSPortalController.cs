...
{
    public class EFSPortalController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "INF0000014";
        private const string URL_SCREEN = "/HRM/HRS/EFSPortal/";
        private string ActionName;
        private string KeyName = "PortalCode;QuestionCode";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        IClsEFSPortal BSM;
        public EFSPortalController()
            : base()
        {
