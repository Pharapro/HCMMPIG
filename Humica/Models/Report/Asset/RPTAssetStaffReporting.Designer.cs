...
{
	partial class RPTAssetStaffReporting
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RPTAssetStaffReporting));
            ...
            this.tableRow2});
			this.table2.SizeF = new System.Drawing.SizeF(1580F, 27.17F);
			...
			this.tableCell20.Weight = 0.366665158215677D;
			// 
			// tableCell21
			// 
			...
			this.tableCell21.Weight = 1.0250017742396347D;
			// 
			// tableCell7
			// 
			...
			this.tableCell7.Weight = 0.92999737389707571D;
			// 
			// tableCell23
			// 
			...
			this.tableCell27.Weight = 1.4483328046799249D;
			// 
			// tableCell28
			// 
			...
			this.tableCell28.Weight = 2.03333235709553D;
			// 
			// tableCell32
			// 
			...
			this.tableCell32.Weight = 0.94833337053372269D;
			// 
			// tableCell33
			// 
			...
			this.tableCell33.Weight = 0.94833335900190852D;
			// 
			// tableCell36
			// 
			...
			this.tableCell38.Weight = 1.0499976732242082D;
			// 
			// tableCell18
			// 
			...
			this.tableCell18.Weight = 1.666670640603461D;
			// 
			// BottomMargin
			// 
            ...
            this.tableRow1});
			this.table1.SizeF = new System.Drawing.SizeF(1580F, 27.17F);
			...
			this.tableCell1.Weight = 0.3666651977293553D;
			// 
			// tableCell3
			// 
			...
			this.tableCell3.Weight = 1.0250016450268904D;
			// 
			// tableCell2
			// 
			...
			this.tableCell2.Weight = 0.92999749861194991D;
			// 
			// tableCell4
			// 
			...
			this.tableCell8.Weight = 1.4483321180346178D;
			// 
			// tableCell9
			// 
			...
			this.tableCell9.Weight = 2.0333319756259147D;
			// 
			// tableCell13
			// 
			...
			this.tableCell13.Weight = 0.94833466753041384D;
			// 
			// tableCell14
			// 
			...
			this.tableCell14.Weight = 0.94833282494444671D;
			// 
			// tableCell17
			// 
			...
			this.tableCell17.Weight = 0.7699985503537492D;
			// 
			// tableCell19
			// 
			...
			this.tableCell19.Weight = 1.0499972154606696D;
			// 
			// tableCell16
			// 
			...
			this.tableCell16.Weight = 1.6666707905451055D;
			// 
			// ReportHeader
			// 
			...
			this.label3.LocationFloat = new DevExpress.Utils.PointFloat(1515F, 23.00002F);
			this.label3.Multiline = true;
			this.label3.Name = "label3";
			this.label3.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.label3.SizeF = new System.Drawing.SizeF(65.00024F, 23F);
			this.label3.StylePriority.UseFont = false;
			this.label3.StylePriority.UseTextAlignment = false;
			this.label3.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			this.label3.TextFormatString = "{0:MM/dd/yyyy}";
			// 
			// label5
			// 
			this.label5.Font = new DevExpress.Drawing.DXFont("Arial", 7F);
			this.label5.LocationFloat = new DevExpress.Utils.PointFloat(1450.833F, 23.00002F);
			...
			this.label4.LocationFloat = new DevExpress.Utils.PointFloat(1515F, 0F);
			...
			// label1
			// 
			this.label1.Font = new DevExpress.Drawing.DXFont("Arial", 7F);
			this.label1.LocationFloat = new DevExpress.Utils.PointFloat(1450.833F, 0F);
			this.label1.Multiline = true;
			this.label1.Name = "label1";
			this.label1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.label1.SizeF = new System.Drawing.SizeF(64.16711F, 23F);
			...
			this.label2.LocationFloat = new DevExpress.Utils.PointFloat(232.1665F, 0F);
			this.label2.Multiline = true;
			this.label2.Name = "label2";
			this.label2.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.label2.SizeF = new System.Drawing.SizeF(1076.167F, 33.33334F);
			this.label2.StylePriority.UseFont = false;
			this.label2.StylePriority.UseTextAlignment = false;
			this.label2.Text = "Asset Staff Record";
			...
			storedProcQuery1.Name = "HR_RPT_AssetStaff";
            ...
            queryParameter9,
            queryParameter10});
			storedProcQuery1.StoredProcName = "HR_RPT_AssetStaff";
			...
			this.ToDate.ValueInfo = "2025-04-18";
			// 
			// Status
			// 
			this.Status.Name = "Status";
			// 
			// RPTAssetStaffReporting
			// 
            ...
            this.sqlDataSource1});
			this.DataMember = "HR_RPT_AssetStaff";
			this.DataSource = this.sqlDataSource1;
			this.DisplayName = "RPTAssetStaffReporting";
