...
namespace Humica.Controllers.HRM.Mission
{
    public class MISPlanController : Humica.EF.Controllers.MasterSaleController
    {
        ...
        public ActionResult Index()
        {
            ...
            BSM.ListPending = new List<ClsHRMissPlanPending>();
        ...
        public ActionResult PartialList()
        {
            ...
            {
                BSM = (ClsHRMissPlan)Session[Index_Sess_Obj + ActionName];
            }
        ...
        [HttpPost]
        public ActionResult Create(ClsHRMissPlan collection)
        {
            ActionName = "Create";
            UserSession();
            DataSelector();
        ...
        [HttpPost]
        public ActionResult Edit(string DocNo, ClsHRMissPlan collection)
        {
            ActionName = "Create";
            UserSession();
            UserConfListAndForm();
