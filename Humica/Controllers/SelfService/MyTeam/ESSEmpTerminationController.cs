...
{
    public class ESSEmpTerminationController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "ESS0000026";
        private const string URL_SCREEN = "/SelfService/MyTeam/ESSEmpTermination/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName;
        private string KeyName = "ID";
        private string DOCTYPE = "TER";
        private string PATH_FILE = "12313123123sadfsdfsdfsdf";
        ICLsESSEmpTermination BSM;
        IUnitOfWork unitOfWork;
        public ESSEmpTerminationController()
            : base()
        {
        ...
        public ActionResult Index()
        {
            ...
            BSM.LoadData(userName, "TERMINAT");
        ...
        public ActionResult PartialList()
        {
            ...
            {
                BSM = (CLsESSEmpTermination)Session[Index_Sess_Obj + ActionName];
            }
        ...
        public ActionResult Create(CLsESSEmpTermination collection)
        {
            ...
            if (collection.Header != null)
            {
                ...
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    var obj = (CLsESSEmpTermination)Session[Index_Sess_Obj + ActionName];
                ...
                BSM.DocType = DOCTYPE;
                string msg = BSM.SaveResign(false);
        ...
        public ActionResult DocumentViewerPartial(string Doc)
        {
            ...
            UserConf(ActionBehavior.VIEWONLY);
            ActionName = "Print";
            var SD = unitOfWork.Set<HREFEmpResign>().AsQueryable().FirstOrDefault(w => w.DocumentNo == Doc && w.ResignType == "TERMINAT");
            if (SD != null)
            {
                try
                {
                    ViewData[Humica.EF.SYSConstant.PARAM_ID] = Doc;
                    var sa = new RPTRequestTerminat();
        ...
        public ActionResult DocumentViewerExportTo(string Doc)
        {
            ...
            if (SD != null)
            {
                RPTRequestTerminat reportModel = new RPTRequestTerminat();

                reportModel = (RPTRequestTerminat)Session[Index_Sess_Obj + ActionName];
        ...
        public ActionResult Details(string Doc)
        {
            ...
            if (Doc != null)
            {
                BSM.Header = unitOfWork.Set<HREFEmpResign>().AsQueryable().FirstOrDefault(w => w.DocumentNo == Doc && w.ResignType == "TERMINAT");
                if (BSM.Header != null)
                {
                    BSM.ListApproval = new List<ExDocApproval>();
        ...
        public ActionResult RequestForApproval(string Doc)
        {
            ...
            {
                BSM.ScreenId = SCREEN_ID;
                var Objmatch = unitOfWork.Set<HREFEmpResign>().AsQueryable().FirstOrDefault(w => w.DocumentNo == Doc && w.ResignType == "TERMINAT");
                if (Objmatch != null)
                {
                    ...
                    RPTRequestTerminat sa = new RPTRequestTerminat();
                    var reportHelper = new clsReportHelper();
                    string path = reportHelper.Get_Path(SCREEN_ID);
                    if (!string.IsNullOrEmpty(path))
                    {
                    ...
                    string msg = BSM.RequestForApprove(Doc, fileName, URL, false);
                    if (msg == SYConstant.OK)
                    {
        ...
        public ActionResult Approve(string Doc)
        {
            ...
            foreach (var Document in c)
            {
                ...
                var Objmatch = unitOfWork.Set<HREFEmpResign>().AsQueryable().FirstOrDefault(w => w.DocumentNo == Document && w.ResignType == "TERMINAT");
                if (!string.IsNullOrEmpty(Document) && Objmatch != null)
                {
                    ...
                    sa.ExportToPdf(fileName);
                    msg = BSM.approveTheDoc(Document, fileName, URL, false);
        ...
        public ActionResult Reject(string Doc)
        {
            ...
            {
                BSM.ScreenId = SCREEN_ID;
                string msg = BSM.Reject(Doc, false);
                if (msg == SYConstant.OK)
                {
                    SYMessages messageObject = SYMessages.getMessageObject(msg, user.Lang);
        ...
        public ActionResult Cancel(string Doc)
        {
            ...
            {
                BSM.ScreenId = SCREEN_ID;
                string msg = BSM.Cancel(Doc, false);
                if (msg == SYConstant.OK)
                {
