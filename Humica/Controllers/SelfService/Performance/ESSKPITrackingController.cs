...
namespace Humica.Controllers.SelfService.Performance
{
    public class ESSKPITrackingController : Humica.EF.Controllers.MasterSaleController
    {
        ...
        public ActionResult Index()
        {
			...
			BSM.OnIndexLoading(BSM.FInYear.INYear, BSM.FInYear.FromDate, BSM.FInYear.ToDate, BSM.FInYear.Status, true);
        ...
        public ActionResult Reject(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                BSM.ScreenId = SCREEN_ID;
                string msg = BSM.Reject(id, comment, true);
                if (msg == SYConstant.OK)
                {
        ...
        public ActionResult UploadControlCallbackActionESSTimeSheet(HttpPostedFileBase file_Uploader)
        {
            UserSession();
            ...
            UploadedFile[] files = UploadControlExtension.GetUploadedFiles("FileUploadESSTimeSheet",
