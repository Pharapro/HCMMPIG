...
{
    public class RPTKPIIndicatorController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTAP00010";
        private const string URL_SCREEN = "/Reporting/RPTKPIIndicator/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        private const string REPORT_PARTIAL = "PrintForm";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTKPIIndicatorController()
            : base()
        {
