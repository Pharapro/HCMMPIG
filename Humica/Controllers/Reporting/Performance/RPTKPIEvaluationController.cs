...
{
    public class RPTKPIEvaluationController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTAP00007";
        private const string URL_SCREEN = "/Reporting/RPTKPIEvaluation/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        private const string REPORT_PARTIAL = "PrintForm";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTKPIEvaluationController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTSumKPIEvaluation sa = new RPTSumKPIEvaluation();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTSumKPIEvaluation reportModel = (RPTSumKPIEvaluation)Session[Index_Sess_Obj];
