...
{
    public class RPTLeaveTrackingController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTLM00004";
        private const string URL_SCREEN = "/Reporting/RPTLeaveTracking/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTLeaveTrackingController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTLeaveTracking sa = new RPTLeaveTracking();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTLeaveTracking reportModel = (RPTLeaveTracking)Session[Index_Sess_Obj];
