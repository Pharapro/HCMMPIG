...
{
    public class RPTEmployeeLeaveController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTLM00005";
        private const string URL_SCREEN = "/Reporting/RPTEmployeeLeave/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTEmployeeLeaveController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTEmployeeLeave sa = new RPTEmployeeLeave();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTEmployeeLeave reportModel = (RPTEmployeeLeave)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
            ...
            ViewData["STATUS_SELECT"] = DB.SYDatas.Where(w => w.DropDownType == "STATUS_EMPLOYEE").ToList();
        }
    }
}