...
{
    public class RPTAttSummaryByDeptReportController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTAT00009";
        private const string URL_SCREEN = "/Reporting/RPTAttSummaryByDeptReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTAttSummaryByDeptReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
					...
					RptAttSummaryByDept sa = new RptAttSummaryByDept();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptAttSummaryByDept reportModel = (RptAttSummaryByDept)Session[Index_Sess_Obj];
