...
{
    public class RPTOnsiteRecordReportController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTAT00010";
        private const string URL_SCREEN = "/Reporting/RPTOnsiteRecordReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTOnsiteRecordReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
					...
					RptOnSiteRecord sa = new RptOnSiteRecord();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTAbsence reportModel = (RPTAbsence)Session[Index_Sess_Obj];
