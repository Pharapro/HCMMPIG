...
{
    public class RPTEmpBirthdayController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTHR00017";
        private const string URL_SCREEN = "/Reporting/RPTEmpBirthday/";
        ...
        public RPTEmpBirthdayController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTEmpBirthday sa = new RPTEmpBirthday();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTEmpBirthday reportModel = (RPTEmpBirthday)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
            ...
            ViewData["LOCATION_SELECT"] = DB.HRLocations.Where(w => w.IsActive == true).ToList();
        }
    }
}
