...
{
    public class RPTStaffTurnOverReportController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTHR00016";
        private const string URL_SCREEN = "/Reporting/RPTStaffTurnOverReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTStaffTurnOverReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptStaffTurnOver sa = new RptStaffTurnOver();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
				RptStaffTurnOver reportModel = (RptStaffTurnOver)Session[Index_Sess_Obj];
