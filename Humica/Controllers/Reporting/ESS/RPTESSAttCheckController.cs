...
{
    public class RPTESSAttCheckController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTESS0006";
        private const string URL_SCREEN = "/Reporting/RPTESSAttCheck/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        IClsFilter BSM;
        IUnitOfWork unitOfWork;
        public RPTESSAttCheckController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTAttCheck sa = new RPTAttCheck();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTAttCheck reportModel = (RPTAttCheck)Session[Index_Sess_Obj];
