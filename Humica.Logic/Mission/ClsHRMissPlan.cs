...
{
    public class ClsHRMissPlan : IClsHRMissPlan
    {
        ...
        public List<ClsHRMissPlanPending> ListPending { get; set; }
        ...
        private void AddPendingToList(ExDocApproval item, List<HRMissionPlan> listobj)
        {
            foreach (var read in listobj)
            {
                ...
                if (empSupense != null)
                {
                    var ListPen = new ClsHRMissPlanPending()
                    {
        ...
        public string CreateMissPlan()
        {
            ...
            try
            {
                ...
                Header.TotalAmount = Header.TotalAmount;
    ...
    public class ClsHRMissPlanPending
    {
